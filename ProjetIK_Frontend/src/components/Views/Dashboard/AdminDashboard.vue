<template>
  ...
  import AddManufacture from '../../AddManufact.vue';
  import AddCategory from '../../AddCategory.vue';
  import ListProductsAdmin from '../../ListProductsAdmin.vue';
  import ListManufactAdmin from '../../ListManufactAdmin.vue';
      ...
      menuItems() {
        return [
          ...
          },
          {
            ...
            items: [
              { label: 'List Manufacturers', command: () => this.setActivePage('ListManufactAdmin') },
              { label: 'Add Manufacturer', command: () => this.setActivePage('AddManufacture') },
            ],
          },
          {
            label: 'Category',
